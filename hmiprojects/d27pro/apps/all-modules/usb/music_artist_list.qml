...
HSTab {
    ...
    property var songlist: musicctl ? musicctl.songlist : null
...
//                    console.debug("music_all_list test:",musicinfo)
//                    console.debug("trackArtist:",trackArtist)
                ...
                onClicked:{
                    application.changePage('music_playing',{
                                               ...
                                               properties: {
                                                   ...
                                                   trackId: ID,
                                                   trackPath:null,
                                                   trackPlayRangen:Constant._PLAY_RANGE_SINGER
                                               },
                                               needUpdate: true
                                           });
                }
            ...
            listView.paginationLoaderDelegate: UControls.PaginationLoaderDelegate {
                function loadPageAsync(page, cb) {
                    ...
                    musicctl.songlistChanged.connect(function handler(songlist){
                        ...
                        console.debug("music_artist_list songlist : " + device);
                    });
                    if(mediaMusic > 0){
                        var data = [artist ,page]
                        musicctl.getSongByArtist(data);
                        console.debug("musicinfo test:")
                    } else {
                        cb(null, []) ;
                    }
                }
