...
//    property alias rectangle: rectangle
    ...
    property alias longPressingGradientGradient: linearGradient.longPressingGradient
    ...
    property alias longPressingGradientGradientDirection: linearGradient.longPressingGradientDirection
